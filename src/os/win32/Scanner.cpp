...
namespace hat::experimental {
    ...
    template<>
    scan_result find_vtable<compiler_type::MSVC>(const std::string& className, const hat::process::module_t mod) {
    ...
    template<>
    scan_result find_vtable<compiler_type::GNU>(const std::string& className, const hat::process::module_t mod) {
        // Tracing cross-references
